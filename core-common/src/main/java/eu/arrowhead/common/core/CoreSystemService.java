...
public enum CoreSystemService {
	...
	CONFIGURATION_SERVICE(CommonConstants.CORE_SERVICE_CONFIGURATION_PROCESS, CommonConstants.CONFIGURATION_URI +  CommonConstants.OP_CONFIGURATION_CONF),
	CONFIGURATION_MANAGE_SERVICE(CommonConstants.CORE_SERVICE_CONFIGURATION_PROCESS, CommonConstants.CONFIGURATION_URI +  CommonConstants.OP_CONFIGURATION_MGMT_MANAGE),
